...
[cite_start]El proyecto está configurado para ejecutarse localmente de forma sencilla siguiendo estos pasos[cite: 15]:

1. **Clonar el repositorio:**
   ```bash
   git clone [https://github.com/tu-usuario/pt-taskflow-](https://github.com/tu-usuario/pt-taskflow-)[tu-nombre].git
